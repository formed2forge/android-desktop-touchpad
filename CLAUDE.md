...
- AIDL methods (oneway): moveCursor, click, rightClick, scroll, startDrag, endDrag, sendKeyEvent, sendShellCommand, destroy
...
| 1 holds + 2nd moves | drag | startDrag/endDrag | UHID button=1 hold |
